...
theorem square_mod_3 (n : ℤ) : n^2 ≡ 0 [ZMOD 3] ∨ n^2 ≡ 1 [ZMOD 3] := by
  mod_cases h : n % 3
...
theorem problem_21 (n : ℤ) : n^2 - 2 * n + 5 ≡ 1 [ZMOD 3] ∨ n^2 - 2 * n + 5 ≡ 2 [ZMOD 3] := by
  mod_cases h : n % 3
  have h1: n ≡ 0 [ZMOD 3] := h
  right
  calc
...
theorem problem_23 (n : ℤ) : ¬ (3 ∣ (7 * n^2 - 2 * n - 10)) := by
  intro h_div
  rw [← modEq_zero_iff_dvd] at h_div
  mod_cases h : n % 3
  have h1: n ≡ 0 [ZMOD 3] := h
...
theorem problem_24 (n : ℤ) : ¬(-4 * n^3 - n^2 + 1 ≡ 0 [ZMOD 3]) := by
  intro h_div
  mod_cases h : n % 3
  have h1: n ≡ 0 [ZMOD 3] := h
...
theorem problem_25 (n : ℤ) : -2 * n^3 - 6 * n^2 + 2 * n + 9 ≡ 0 [ZMOD 3] := by
  mod_cases h : n % 3
  have h1: n ≡ 0 [ZMOD 3] := h
  calc
    -2 * n^3 - 6 * n^2 + 2 * n + 9
...
theorem problem_30 (n : ℤ) : -n^524 - n^708 + n^549 ≡ 0 [ZMOD 3] ∨ -n^524 - n^708 + n^549 ≡ 2 [ZMOD 3] := by
  mod_cases h : n % 3
  have h1: n ≡ 0 [ZMOD 3] := h
  left
  calc
